...
type QueryResolver interface {
	...
	InforAccount(ctx context.Context, account model.TokenAccount) (*model.Account, error)
}
...
func (ec *executionContext) field_Query_inforAccount_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := ec.field_Query_inforAccount_argsAccount(ctx, rawArgs)
	if err != nil {
		return nil, err
	}
	args["account"] = arg0
...
func (ec *executionContext) field_Query_inforAccount_argsAccount(
	ctx context.Context,
	rawArgs map[string]any,
) (model.TokenAccount, error) {
	if _, ok := rawArgs["account"]; !ok {
		var zeroVal model.TokenAccount
		return zeroVal, nil
	}

	ctx = graphql.WithPathContext(ctx, graphql.NewPathWithField("account"))
	if tmp, ok := rawArgs["account"]; ok {
		return ec.unmarshalNTokenAccount2ThaiLyᚋgraphᚋmodelᚐTokenAccount(ctx, tmp)
	}
...
func (ec *executionContext) _Query_inforAccount(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (any, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().InforAccount(rctx, fc.Args["account"].(model.TokenAccount))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) fieldContext_Query_inforAccount(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Query",
		Field:      field,
		IsMethod:   true,
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Query_inforAccount_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return fc, err
	}
	return fc, nil
...
func (ec *executionContext) unmarshalInputTokenAccount(ctx context.Context, obj any) (model.TokenAccount, error) {
	var it model.TokenAccount
	asMap := map[string]any{}
	for k, v := range obj.(map[string]any) {
		asMap[k] = v
	}
...
func (ec *executionContext) unmarshalNTokenAccount2ThaiLyᚋgraphᚋmodelᚐTokenAccount(ctx context.Context, v any) (model.TokenAccount, error) {
	res, err := ec.unmarshalInputTokenAccount(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}
